...
module.exports = {
  ...
  child: {
    rpc: '', // This is the pano testnet RPC
  },
  pos: {
    parent: {
  ...
  SYNCER_URL: '', // Backend service which syncs the Pano sidechain state to a MySQL database which we use for faster querying. This comes in handy especially for constructing withdrawal proofs while exiting assets from Plasma.
  WATCHER_URL: '', // Backend service which syncs the Pano Plasma contract events on Ethereum mainchain to a MySQL database which we use for faster querying. This comes in handy especially for listening to asset deposits on the Plasma contract.
  user1: {
    privateKey: '',
    address: '',
  },
